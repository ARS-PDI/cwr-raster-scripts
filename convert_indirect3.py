# Converts GeoTIFF raster datasets in an folder of folders of folders
...
if __name__ == "__main__":
    if len(sys.argv) == 3:
        ...
        print('Usage: python3 convert_indirect3.py "C:/Users/.../Input Folder" "C:/Users/.../Output Folder"')
        exit(1)
